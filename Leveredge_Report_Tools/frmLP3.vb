...
Public Class frmLP3
    ...
    Private Sub btnBrow_LP3_Dest_Click(sender As Object, e As EventArgs) Handles btnBrow_LP3_Dest.Click
        ...
        Dim filename As String = "Neutralize_LP3_" & LP3RptType & "_" & datenow.ToString("ddMMyyyy_HHmm")
        ...
        Select Case AppsOffice
            Case "XL_NotInstalled"
                ...
                Select Case LP3RptType
                    Case "ALL"
                        Try
                            xlAppLP3 = CreateObject("Ket.Application")
                            ...
                            Dim rg_head_cut1 As Object = xlWsheetLP3.Range("B2")
                            Dim rg_head_paste1 As Object = xlWsheetLP3.Range("A2")
                            rg_head_cut1.Select()
                            rg_head_cut1.Cut(rg_head_paste1)

                            Dim rg_head_cut2 As Object = xlWsheetLP3.Range("B4")
                            Dim rg_head_paste2 As Object = xlWsheetLP3.Range("A4")
                            rg_head_cut2.Select()
                            ...
                            Dim rg1 As Object = xlWsheetLP3.Range("B:C")
                            rg1.EntireColumn.Select()
                            rg1.EntireColumn.Delete()
                            Dim rg2 As Object = xlWsheetLP3.Range("C:F")
                            rg2.EntireColumn.Select()
                            rg2.EntireColumn.Delete()
                            Dim rg3 As Object = xlWsheetLP3.Range("D:E")
                            rg3.EntireColumn.Select()
                            rg3.EntireColumn.Delete()
                            Dim rg4 As Object = xlWsheetLP3.Range("E:I")
                            rg4.EntireColumn.Select()
                            rg4.EntireColumn.Delete()
                            Dim rg5 As Object = xlWsheetLP3.Range("G:I")
                            rg5.EntireColumn.Select()
                            rg5.EntireColumn.Delete()
                            Dim rg6 As Object = xlWsheetLP3.Range("H:I")
                            ...
                            Dim cellrange As Object = xlWsheetLP3.Range(cr)
                            cellrange.Select()
                            ...
                            Dim cellrange2 As Object = xlWsheetLP3.Range(cr2)
                            cellrange2.Select()
                            cellrange2.Delete(Shift:=Excel.XlDirection.xlToLeft)

                            Dim rg7 As Object = xlWsheetLP3.Range("AA:AB")
                            ...
                            Dim cellrange3 As Object = xlWsheetLP3.Range(cr3)
                            cellrange3.Select()
                    ...
                    Case "RPH"
                        Try
                            ...
                            Dim rg1, rg2, rg3, rg4, rg5 As Object
                    ...
                    Case "QTY"
                        Try
                            ...
                            Dim rg1, rg2, rg3, rg4, rg5, rg6, rg7 As Object

...
Public Class frmDSS
    ...
    Private Sub btnBrowDSS_dest_Click(sender As Object, e As EventArgs) Handles btnBrowDSS_dest.Click
        ...
        Dim filename As String = "Neutralize_DailySalesSumm_" & DSStype & "_" & datenow.ToString("ddMMyyyy_HHmm")
        ...
        Select Case AppsOffice
            Case "XL_NotInstalled"
                ...
                Select Case DSStype
                    Case "ALL"
                        Try
                            xlAppDSS = CreateObject("Ket.Application")
                            ...
                            Dim rg_head_cut1 As Object = xlWsheetDSS.Range("B2")
                            Dim rg_head_paste1 As Object = xlWsheetDSS.Range("A2")
                            rg_head_cut1.Select()
                            rg_head_cut1.Cut(rg_head_paste1)

                            Dim rg_head_cut2 As Object = xlWsheetDSS.Range("B4")
                            Dim rg_head_paste2 As Object = xlWsheetDSS.Range("A3")
                            rg_head_cut2.Select()
                            ...
                            Dim cellrange2 As Object = xlWsheetDSS.Range(cr2)
                            cellrange2.Select()
                            ...
                            Dim cellrange3 As Object = xlWsheetDSS.Range(cr3)
                            cellrange3.Select()
                            ...
                            Dim cellrange4 As Object = xlWsheetDSS.Range(cr4)
                            cellrange4.Select()
                            ...
                            Dim cellrange5 As Object = xlWsheetDSS.Range(cr5)
                            cellrange5.Select()
                            ...
                            Dim cellrange6 As Object = xlWsheetDSS.Range(cr6)
                            cellrange6.Select()
                            ...
                            Dim cellrange7 As Object = xlWsheetDSS.Range(cr7)
                            cellrange7.Select()
                    ...
                    Case "RUPIAH"
                        Try
                            ...
                            Dim rg1, rg2, rg3, rg4, rg5, rg6, rg7, rg8 As Object
                    ...
                    Case "PRODUK"
                        Try
                            ...
                            Dim cellrange As Object = xlWsheetDSS.Range(cr1)
                            cellrange.Select()

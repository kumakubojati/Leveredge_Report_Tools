    ...
    Private Sub BWDSR_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BWDSR.DoWork
        Select Case AppsOffice
            Case "XL_NotInstalled"
                ...
                Try
                    xlAppDistStock = CreateObject("Ket.Application")
                    ...
                    Dim rg_head_cut1 As Object = xlWsheetDistStock.Range("B2")
                    Dim rg_head_paste1 As Object = xlWsheetDistStock.Range("A2")
                    rg_head_cut1.Select()
                    rg_head_cut1.Cut(rg_head_paste1)

                    Dim rg_head_cut2 As Object = xlWsheetDistStock.Range("B3")
                    Dim rg_head_paste2 As Object = xlWsheetDistStock.Range("A3")
                    rg_head_cut2.Select()
                    ...
                    Dim rg1, rg2, rg3, rg4, rg5, rg6, rg7, rg8, rg9, rg10 As Object
                    ...
                    xlWsheetDistStock.Range("A9:A10").HorizontalAlignment = 3
                    xlWsheetDistStock.Range("B9:B10").Merge()
                    xlWsheetDistStock.Range("B9:B10").HorizontalAlignment = 3
                    xlWsheetDistStock.Range("C9:C10").Merge()
                    xlWsheetDistStock.Range("C9:C10").HorizontalAlignment = 3
                    xlWsheetDistStock.Range("D9:D10").Merge()
                    xlWsheetDistStock.Range("D9:D10").HorizontalAlignment = 3
                    xlWsheetDistStock.Range("E9:G9").Merge()
                    xlWsheetDistStock.Range("E9:G9").HorizontalAlignment = 3
                    xlWsheetDistStock.Range("H9:H10").Merge()
                    xlWsheetDistStock.Range("H9:H10").HorizontalAlignment = 3
                    xlWsheetDistStock.Range("H9:H10").WrapText = True
                    xlWsheetDistStock.Range("I9:I10").Merge()
                    xlWsheetDistStock.Range("I9:I10").HorizontalAlignment = 3
                    xlWsheetDistStock.Range("I9:I10").WrapText = True
                    xlWsheetDistStock.Range("J9:J10").Merge()
                    xlWsheetDistStock.Range("J9:J10").HorizontalAlignment = 3
                    xlWsheetDistStock.Range("K9:K10").Merge()
                    xlWsheetDistStock.Range("K9:K10").HorizontalAlignment = 3
                    xlWsheetDistStock.Range("L9:L10").Merge()
                    xlWsheetDistStock.Range("L9:L10").HorizontalAlignment = 3
